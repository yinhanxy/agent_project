# Generated by Django 5.2.6 on 2026-05-22 16:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(2, '已锁定'), (1, '已激活'), (0, '未激活')], default=0)),
                ('gender', models.IntegerField(blank=True, choices=[(1, '男'), (2, '女'), (3, '其他')], null=True)),
